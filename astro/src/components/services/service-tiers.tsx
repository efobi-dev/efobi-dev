...
const tiers = [
	...
	},
	{
		...
		unit: "/hour",
		description:
			"Industry expertise. AI-augmented workflows. White-glove service.",
		features: [
			...
			<div className="relative z-10 w-full max-w-[1600px] mx-auto px-6 md:px-12">
				...
				<div className="grid md:grid-cols-12 gap-12 mb-20">
					...
					<div className="md:col-span-6 md:col-start-7 flex items-end">
						...
						>
							Flexible pricing that scales with your needs. No lock-in
							contracts. Cancel anytime. Pay only for what you use.
						</motion.p>
					</div>
				</div>
					...
					<div className="grid md:grid-cols-2 gap-8 items-center">
						<div>
							...
							<p className="text-lg text-accent-foreground leading-relaxed">
								We offer monthly retainers, project-based pricing, and
								enterprise packages. Let's talk about your specific needs.
							</p>
						</div>

          ...
          <div className="md:col-span-7">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-accent-foreground leading-relaxed max-w-xl">
                We deliver data entry, virtual assistance, and specialized back-office services at <strong>3× the speed</strong> and <strong>98% accuracy</strong> by fusing AI automation with Nigerian expertise.
              </p>

              {/* Stats bar - bold numbers */}
              <div className="flex gap-8 md:gap-12 pt-4">
                <div>
                  <div className="text-4xl md:text-5xl font-black text-primary">3×</div>
                  <div className="text-sm text-muted-foreground mt-1">Faster</div>
                </div>
                <div>
                  <div className="text-4xl md:text-5xl font-black text-primary">98%</div>
            ...
            <div className="relative h-[500px] flex items-center justify-center">
              ...
              <div className="relative z-10 space-y-6 p-8">
                <div className="bg-card/80 backdrop-blur-sm border border-border p-6 hover:border-primary/50 transition-colors">
                  <div className="text-sm font-mono text-primary mb-2">→ AI Pre-Processing</div>
                  <div className="text-base text-foreground">Automated workflow analysis & task structuring</div>
                </div>
                
                <div className="bg-card/80 backdrop-blur-sm border border-border p-6 hover:border-primary/50 transition-colors ml-12">
                  <div className="text-sm font-mono text-primary mb-2">→ Human Verification</div>
                  <div className="text-base text-foreground">Expert quality control & final polish</div>
                </div>
                
                <div className="bg-card/80 backdrop-blur-sm border border-border p-6 hover:border-primary/50 transition-colors">
                  <div className="text-sm font-mono text-primary mb-2">→ Continuous Improvement</div>
                  <div className="text-base text-foreground">Learn from every project, faster over time</div>
                </div>
              </div>
            </div>
          </motion.div>
